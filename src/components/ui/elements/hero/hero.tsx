import heroImage from "assets//undraw_nature_m5ll.svg";
...
const Header = tw.h1`text-center lg:text-left text-3xl sm:text-5xl font-light text-nord15 leading-tight mb-4`;
...
const SvgContainer = tw.div`lg:w-1/2 flex flex-col top-0 right-0 bottom-0  lg:mr-8`;
const Img = tw.img`max-w-md object-right`;
